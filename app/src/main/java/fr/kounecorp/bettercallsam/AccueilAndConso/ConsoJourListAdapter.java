...
public class ConsoJourListAdapter extends ArrayAdapter<Consommer> {
    int mResource;
    private Context mContext;

    public ConsoJourListAdapter(Context context, int resource, List<Consommer> objects) {
